...
echo "$SCRIPTPATH/../target/debug/crypto_cli --action-type get_vdf_zkp > $SCRIPTPATH/data/result.txt"
$SCRIPTPATH/../target/debug/crypto_cli --action-type get_vdf_zkp > $SCRIPTPATH/data/result.txt
